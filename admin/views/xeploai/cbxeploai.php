        ...
        <div class="panel-body">
            <div class="dataTable_wrapper">
                <form id="product-form" class="form-horizontal" method="post"
					action="admin.php?controller=xeploai&action=cbxeploai" enctype="multipart/form-data" role="form">
							...
							<tr class="odd gradeX">								
								...
								<td>
									<select class="form-control" id="XepLoai" name="XepLoai[<?php echo $row['idhoso']; ?>][<?php echo $row['Id']; ?>]" >
										<option value="HTXSNV" <?php if ($row['CBXepLoai'] == 'HTXSNV') echo 'selected'; ?> >Hoàn thành xuất sắc nhiệm vụ</option>
										<option value="HTTNV" <?php if ($row['CBXepLoai'] == 'HTTNV') echo 'selected'; ?> >Hoàn thành tốt nhiệm vụ</option>
										<option value="HTNV" <?php if ($row['CBXepLoai'] == 'HTNV') echo 'selected'; ?> >Hoàn thành nhiệm vụ</option>
										<option value="KHTNV" <?php if ($row['CBXepLoai'] == 'KHTNV') echo 'selected'; ?> >Không hoàn thành nhiệm vụ</option>
									</select>
								</td>								
							</tr>
						<?php endforeach; ?>
