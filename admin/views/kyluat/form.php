<form id="product-form" class="form-horizontal" method="post"
	  action="admin.php?controller=kyluat&action=edit" enctype="multipart/form-data" role="form">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Năm kỷ luật</label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Lý do kỷ luật</label>
		<div class="col-sm-9">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">			
			...
			if ($object && $object['File'] != '') {
				echo '<a href="public/upload/kyluat/'. $object['File'] .'" target="blank" data-toggle="tooltip" title="'. $object['File'] .'">'. $object['File'] .'</a> ';
				echo '<a href="admin.php?controller=kyluat&action=deletefile&id='. $object['Id'] .'" class="text-danger deleteitem" data-toggle="tooltip" title="Xóa"><i class="glyphicon glyphicon-remove fa-lg"></i></a></br>';
			} else {
	...
	<div class="form-group">
		<div class="col-sm-offset-3 col-sm-9">
			...
			<a class="btn btn-warning" href="admin.php?controller=kyluat">Trở về</a>
		</div>
	</div>
</form>
