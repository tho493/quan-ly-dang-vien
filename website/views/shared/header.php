			...
			<div class="wrapper">
				...
				<ul class="nav-links">
					...
					<?php if (isset($_SESSION['user'])): ?>
						<li><a href="/hosodangvien/">Hồ sơ đảng viên</a></li>
					<?php endif; ?>
					...
					<li><a href="/bieumau/">Biểu mẫu</a></li>

					<li><a href="https://egov.saodo.edu.vn" target="_blank">E-Gov</a></li>
					<li><a href="https://saodo.edu.vn" target="_blank">Saodo.edu.vn</a></li>

					<?php if (isset($_SESSION['user']) && ($_SESSION['user']['Permission'] != '')) {
						echo '<li><a href="admin.php">Quản trị</a></li>';
					} ?>
